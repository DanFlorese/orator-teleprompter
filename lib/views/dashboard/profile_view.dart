...
class _ProfileViewState extends State<ProfileView> {
  ...
  Future<void> _deleteAccountPermanently() async {
    try {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
            const SnackBar(content: Text("Error: Incorrect password"), backgroundColor: redOrator));
      }
    } finally {
      if (mounted) setState(() => _isLoading = false);
    }
          ...
          return AlertDialog(
            ...
            content: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  const Text('To delete your account permanently, please enter your password.',
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          children: [
            ...
            TextField(
              ...
              decoration: InputDecoration(
                ...
                focusedBorder: OutlineInputBorder(
                    borderRadius: BorderRadius.circular(15), borderSide: const BorderSide(color: redOrator)),
              ),
            ),
            const SizedBox(height: 20),
            TextField(
            ...
            const SizedBox(height: 10),
            _buildLegalTile('Terms & Conditions', 'https://oratorteleprompter.com/terms-and-conditions',
                Icons.description_outlined),
            const SizedBox(height: 12),
            _buildLegalTile(
                'Privacy Policy', 'https://oratorteleprompter.com/privacy-policy', Icons.privacy_tip_outlined),
            const SizedBox(height: 12),
    ...
    return Container(
      ...
      child: const Row(
        ...
        children: [
          ...
          SizedBox(width: 12),
          Text('ORATOR PRO ACTIVE',
              style:
                  TextStyle(color: Color(0xFFFFD700), fontWeight: FontWeight.bold, letterSpacing: 1.2)),
        ],
      ),
    );
  }
